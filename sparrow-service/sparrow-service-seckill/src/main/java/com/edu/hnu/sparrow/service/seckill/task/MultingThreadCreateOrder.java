...
public class MultingThreadCreateOrder {
    ...
    public void creadOrder(){
       ...
       //8. 生成order对象，进行预购
        ...
        ;
//        System.out.println(JSON.parseObject((String)redisTemplate.boundHashOps(CacheKey.SECKILL_QUEUE_REPEAT).put(username,JSON.toJSONString(seckillOrder)),SeckillOrder.class));


//        System.out.println(JSON.parseObject((String)redisTemplate.boundHashOps(CacheKey.SECKILL_QUEUE_REPEAT).get(username),SeckillOrder.class));
